...
When updating the version of the PMToolkit Extension (e.g., from v0.4.0 to v0.5.0), ensure that it is updated in the following locations to maintain consistency across the UI, manifest, and package metadata.
...
3.  **`public/manifest.json`**
    - Update the `"version"` field.
    - Update the `"description"` if it contains a version suffix (e.g., `(Beta v0.5.0)`).
...
5.  **Extension Popup (`index.html` at root)**
    ...
    - Example: `<strong>PMsToolKit v0.5.0</strong>`
